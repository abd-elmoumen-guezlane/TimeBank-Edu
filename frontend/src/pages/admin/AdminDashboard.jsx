...
import { Users, BookOpen, Clock, AlertTriangle, TrendingUp, ChevronRight, UserPlus, Star } from 'lucide-react';
...
const recentActivity = [
  { Icon: UserPlus, color: 'bg-green-100 text-green-600', text: 'Nouvel utilisateur', sub: 'Sara Benali a rejoint la plateforme', time: 'Il y a 5 min' },
  { Icon: BookOpen, color: 'bg-blue-100 text-blue-600', text: 'Nouveau module', sub: 'Algorithme - L2 par Ahmed Moussa', time: 'Il y a 15 min' },
  { Icon: AlertTriangle, color: 'bg-red-100 text-red-600', text: 'Litige signalé', sub: 'Absence non justifiée par Ali Karim', time: 'Il y a 30 min' },
  { Icon: Star, color: 'bg-yellow-100 text-yellow-600', text: 'Évaluation déposée', sub: 'Lina Farah a évalué un tutorat', time: 'Il y a 1h' },
];
  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-6">
        ...
        ].map(({ icon: Icon, val, label, trend, color }) => (
