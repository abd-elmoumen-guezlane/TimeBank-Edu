...
const allHistory = [
  { id: 1, date: '15/05/2024', tutor: 'Ahmed Moussa', avatar: 'AM', module: 'Algorithme - L2', duration: 2, type: 'Donné', status: 'Complété', hours: '+2h', score: 4.8 },
  { id: 2, date: '08/05/2024', tutor: 'Lina Farah', avatar: 'LF', module: 'Analyse 1 - L1', duration: 1, type: 'Reçu', status: 'Complété', hours: '-1h', score: 4.6 },
  { id: 3, date: '01/05/2024', tutor: 'Yassine K.', avatar: 'YK', module: 'Base de Données - L2', duration: 2, type: 'Donné', status: 'Complété', hours: '+2h', score: 4.9 },
  { id: 4, date: '25/04/2024', tutor: 'Fatima Zahra', avatar: 'FZ', module: 'Python - L2', duration: 2, type: 'Reçu', status: 'Complété', hours: '-2h', score: 4.5 },
  { id: 5, date: '18/04/2024', tutor: 'Lina Farah', avatar: 'LF', module: 'Analyse 1 - L1', duration: 1, type: 'Reçu', status: 'Annulé', hours: '0h', score: 4.6 },
  { id: 6, date: '10/04/2024', tutor: 'Ali Karim', avatar: 'AK', module: 'Analyse 1 - L1', duration: 1, type: 'Reçu', status: 'Complété', hours: '-1h', score: 4.2 },
];
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                {['Date', 'Avec', 'Module', 'Note', 'Durée', 'Type', 'Statut', 'Heures'].map(h => (
                ...
                <tr key={h.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1">
                      <StarRating rating={h.score} size={11} />
                      <span className="text-gray-700 text-xs font-medium">{h.score}</span>
                    </div>
                  </td>
